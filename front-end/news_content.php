		...
		<div id="main-content">
			<div class="w3-row">
				<div class="w3-col l9 m9 s12" style="border-right: solid 1px #ccc; height: 100%; padding-top: 20px;">
					...
					?>
					<?php
					$qr_news = "SELECT * FROM tintuc WHERE id=$id_news";
					$news = mysqli_query($conn,$qr_news);
					$row_news = mysqli_fetch_assoc($news);
					?>
					
					<div style="text-align: center;"><a href="news.php" style="color: #555555;font-size: 0.8em;">TIN TỨC</a></div>
				
					<div style="text-align: center"><h4 style="color: #555555;font-weight: bold;"><?php echo $row_news['tieuDe'] ?></h4></div>
