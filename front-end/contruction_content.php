		...
		<div id="main-content">
			<div class="w3-row">
				<div class="w3-col l9 m9 s12" style="border-right: solid 1px #ccc; height: 100%; padding-top: 20px;">
					<?php
					if(isset($_GET['id'])) {
						$id_congtrinh = $_GET['id'];
						settype($id_congtrinh,"int");
					}
					?>
					<?php
					$qr_congtrinh = "SELECT * FROM congtrinh WHERE id=$id_congtrinh";
					$congtrinh = mysqli_query($conn,$qr_congtrinh);
					$row_congtrinh = mysqli_fetch_assoc($congtrinh);
					?>
					<div style="text-align: center;"><a href="contruction.php" style="color: #555555;font-size: 0.8em;">CÔNG TRÌNH</a></div>
				
					<div style="text-align: center"><h4 style="color: #555555;font-weight: bold;"><?php echo $row_congtrinh['tieuDe'] ?></h4></div>
					<div class="project-content">
						<?php echo $row_congtrinh['content'] ?>
					</div>
					<p>
