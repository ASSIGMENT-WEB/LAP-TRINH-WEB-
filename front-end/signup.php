		...
		<div id="main-content">
			...
			<form action="" method="post">
				<p>      
  					...
  					<input class="w3-input w3-border" name="hoten" type="text">
				</p>
  				<p>      
				...
				<p>      
  					...
  					<input class="w3-input w3-border" name="repass" type="password">
				</p>
  				<p>      
 					<button type="submit" class="w3-button" style="font-weight: bold;color: white;background-color: #dd9933;" name="signup">ĐĂNG NHẬP</button>
				</p>
			</form>
		</div>
	</div>
